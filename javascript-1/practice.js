...
console.log(bigOrSmall([100, 2, 120, 40, 150]));
...
var doubled = myNumbers.map(element=> element * 2);
...
var filtered = myNumbers.filter(element => element>100);
...
var total = myNumbers.reduce((acc, cur) => acc + cur);
...
console.log('hereeeeee', myNumbersIndex);
...
var forTheLoveOfGeorge = notGeorge.map(element => element = "George");
...
var enemies = people.filter((element, index) => people[index].friend === false);
...
console.log("herrerer", totallyAwesome);
